...
export class Contact extends Component<ContactProps> {
    ...
    submitMessage(event: FormEvent) {
        // TODO
    }

    render() {
        const { contactMessage, location: { city, country }, name, phone } = this.props.basic;
        ...
        return <section id="contact">
            ...
            <div className="row">
                <div className="eight columns">
                    <form onSubmit={this.submitMessage} action="#" method="post" id="contactForm" name="contactForm">
                        <fieldset>
                            <div>
